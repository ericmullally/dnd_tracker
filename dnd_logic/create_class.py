...
def choose_class(class_name, name, race, background, chosen_skills):

    if class_name == "Barbarian":
        return Barbarian.Barbarian(name, race, background, chosen_skills)
    elif class_name == "Bard":
        return Bard.Bard(name, race, background, chosen_skills)
    elif class_name == "Cleric":
        return Cleric.Cleric(name, race, background, chosen_skills)
    elif class_name == "Druid":
        return Druid.Druid(name, race, background, chosen_skills)
    elif class_name == "Fighter":
        return Fighter.Fighter(name, race, background, chosen_skills)
    elif class_name == "Monk":
        return Monk.Monk(name, race, background, chosen_skills)
        ...
        return Warlock.Warlock(name, race, background, chosen_skills)
    elif class_name == "Wizard":
        return Wizard.Wizard(name, race, background, chosen_skills)
    else:
        raise ValueError(
