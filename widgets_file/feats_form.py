...
class Ui_feats_form(object):
    def setupUi(self, feats_form):
        ...
        self.feats_input.setStyleSheet("background-color:#eaebeb; color:black;")
        ...
        self.description_input.setStyleSheet("background-color:white; color:black;")
